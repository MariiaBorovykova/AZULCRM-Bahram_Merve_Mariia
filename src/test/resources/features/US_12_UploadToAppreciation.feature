Feature: User should be able to upload files and pictures to appreciation
  ...
  Scenario Outline: Verify that the user can insert the files and images into the text.
    ...
    Then user click on a More tab
    And user click Appreciation tab
    Then user can write "Appreciation with file" in the Message title field
    Then user click on "Upload files"
    And user upload the "<file>"
  ...
  Scenario Outline: Verify that the user can remove files and images at any time before sending.
    ...
    Then user click on a More tab
    And user click Appreciation tab
    Then user can write "Appreciation without file" in the Message title field
    Then user click on "Upload files"
    And user upload the "<file>"
    Then user click on Insert in text button
    Then user click on Delete from text button
    Then user click on Send button
    Then user can see created post with Message title "Appreciation without file "
    Examples:
      | user type      | file           |
      #| Helpdesk user  | PNG_File.png   |
      #| Marketing user | PNG_File.png   |
